...
import { BaseDialog, StaffPaymentDialog } from '../../src/components/dialogs'
import { GenColSummary } from '../../src/components/collateral/generalCollateral'
import { SecuredPartySummary, DebtorSummary } from '../../src/components/parties/summaries'
import { RegisteringPartyChange } from '../../src/components/parties/party'
import { AmendmentDescription, RegistrationLengthTrustAmendment } from '../../src/components/registration'
import { VehicleCollateral } from '../../src/components/collateral/vehicleCollateral'
import { unsavedChangesDialog } from '../../src/resources/dialogOptions'
...
import type {
  APIRegistrationTypes} from '../../src/enums';
import {
  ActionTypes,
  RouteNames,
  UIRegistrationTypes
