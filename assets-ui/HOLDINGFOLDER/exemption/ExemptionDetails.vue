...
import { docIdContent, exRemarksContent } from '../../src/resources'
import { ExemptionDeclaration, ExemptionSimpleHelp, NonResExemptionSimpleHelp } from '../../src/components/exemptions'
import { CautionBox, DocumentId, Remarks, SimpleHelpToggle, LienAlert } from '../../src/components/common'
import { HomeLocationReview, HomeOwnersReview, YourHomeReview } from '../../src/components/mhrRegistration/ReviewConfirm'
import { useExemptions, useNavigation } from '../../src/composables'
import { RouteNames } from '../../src/enums'
import FormCard from '../../src/components/common/FormCard.vue'
