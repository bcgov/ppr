...
import { createExemption, getFeatureFlag, scrollToFirstVisibleErrorComponent } from '../../src/utils'
import { ButtonFooter, Stepper, StickyContainer } from '../../src/components/common'
import { MhrExemptionFooterConfig } from '../../src/resources/buttonFooterConfig'
import { useAuth, useExemptions, useMhrInformation, useNavigation } from '../../src/composables'
import type { ErrorIF, RegTableNewItemI } from '../../src/interfaces'
