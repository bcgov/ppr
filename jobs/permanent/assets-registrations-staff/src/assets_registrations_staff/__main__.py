...
from assets_registrations_staff.utils.logging import logger, setup_logging
...
if __name__ == "__main__":
    try:
        ...
        logger.info(f"Assets staff registrations job starting. DB url={config.APP_DATABASE_URI}")
        job(config)
