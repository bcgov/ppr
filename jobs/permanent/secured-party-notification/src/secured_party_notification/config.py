...
class Config(BaseConfig):
    ...
    REPORT_API_AUDIENCE = os.getenv("REPORT_API_AUDIENCE", REPORT_API_URL)
    ...
    JOB_INTERVAL_HOURS = os.getenv("JOB_INTERVAL_HOURS", "25")
    RERUN_JOB_ID = os.getenv("RERUN_JOB_ID", "")
    # UTC timestamp with no time zone format YYYY-MM-DD HH24:MI:SS
    RANGE_START_TS = os.getenv("RANGE_START_TS", "")
    RANGE_END_TS = os.getenv("RANGE_END_TS", "")
    ...
    GCP_CS_BUCKET_ID_MAIL = os.getenv("GCP_CS_BUCKET_ID_MAIL", "")
    ...
    SFTP_STORAGE_DIRECTORY = os.getenv("SFTP_STORAGE_DIRECTORY", "")
    SFTP_HOST = os.getenv("SFTP_HOST", "")
    SFTP_PORT = os.getenv("SFTP_PORT", "22")
    SFTP_USERNAME = os.getenv("SFTP_USERNAME", "")
    SFTP_PASSWORD = os.getenv("SFTP_PASSWORD", "")
    SFTP_PRIVATE_KEY_ALGORITHM = os.getenv("SFTP_PRIVATE_KEY_ALGORITHM", "RSA")
