...
class MhrDocumentType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    document_type = db.mapped_column(
        "document_type", PG_ENUM(MhrDocumentTypes, name="mhr_document_type"), primary_key=True
    )
...
class MhrLocationType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    location_type = db.mapped_column(
        "location_type", PG_ENUM(MhrLocationTypes, name="mhr_location_type"), primary_key=True
    )
...
class MhrNoteStatusType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    status_type = db.mapped_column(
        "status_type", PG_ENUM(MhrNoteStatusTypes, name="mhr_note_status_type"), primary_key=True
    )
...
class MhrOwnerStatusType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    status_type = db.mapped_column(
        "status_type", PG_ENUM(MhrOwnerStatusTypes, name="mhr_owner_status_type"), primary_key=True
    )
    status_type_desc = db.mapped_column("status_type_desc", db.String(100), nullable=False)
    legacy_status_type = db.mapped_column("legacy_status_type", db.String(1), nullable=False)
...
class MhrPartyType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    party_type = db.mapped_column("party_type", PG_ENUM(MhrPartyTypes, name="mhr_party_type"), primary_key=True)
...
class MhrRegistrationStatusType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    status_type = db.mapped_column(
        "status_type", PG_ENUM(MhrRegistrationStatusTypes, name="mhr_registration_status_type"), primary_key=True
    )
    status_type_desc = db.mapped_column("status_type_desc", db.String(100), nullable=False)
    legacy_status_type = db.mapped_column("legacy_status_type", db.String(1), nullable=False)
...
class MhrRegistrationType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    registration_type = db.mapped_column(
        "registration_type", PG_ENUM(MhrRegistrationTypes, name="mhr_registration_type"), primary_key=True
    )
...
class MhrStatusType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    status_type = db.mapped_column("status_type", PG_ENUM(MhrStatusTypes, name="mhr_status_type"), primary_key=True)
    status_type_desc = db.mapped_column("status_type_desc", db.String(100), nullable=False)
    legacy_status_type = db.mapped_column("legacy_status_type", db.String(1), nullable=False)
...
class MhrTenancyType(db.Model):  # pylint: disable=too-few-public-methods
    ...
    tenancy_type = db.mapped_column("tenancy_type", PG_ENUM(MhrTenancyTypes, name="mhr_tenancy_type"), primary_key=True)
