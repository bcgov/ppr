...
class Payment:
    ...
    def create_payment_search(self, selections, transaction_id=None, client_reference_id=None, staff_gov=False):
        ...
        try:
            ...
            if self.api_url:
                api_instance.api_url = self.api_url
            api_response = api_instance.create_payment_search(
                selections, transaction_id, client_reference_id, staff_gov
            )
            logger.debug(api_response)
            return api_response
    ...
    def create_payment_staff_search(self, selections, transaction_info, transaction_id=None, client_reference_id=None):
        ...
        try:
            ...
            if self.api_url:
                api_instance.api_url = self.api_url
            api_response = api_instance.create_payment_staff_search(
                selections, transaction_info, transaction_id, client_reference_id
            )
            logger.debug(api_response)
            return api_response
