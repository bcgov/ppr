...
-- With 16418 DEV 2023-05-23 TEST 2023-05-24 SANDBOX 2023-05-24 PROD 2023-05-29
...
-- Preserve existing account id's here to restore after the load.
DELETE
  FROM mhr_manufacturers
 WHERE id < 200000000
;
SELECT setval('mhr_manufacturer_id_seq', 1);
...
-- PROD
select nextval('mhr_registration_id_seq'); -- reg_id
select nextval('address_id_seq'); -- add_sub_id
select nextval('address_id_seq'); -- add_own_Id
select nextval('mhr_party_id_seq'); -- sub_id
select nextval('mhr_party_id_seq'); -- owner_id
select nextval('mhr_party_id_seq'); -- dealer_id


INSERT INTO mhr_registrations (id, mhr_number, account_id, registration_type, registration_ts, status_type, draft_id, 
                               pay_invoice_id, pay_path, user_id)
     VALUES (reg_id, 'MAN000', 'SYSTEM', 'MANUFACTURER', now() at time zone 'UTC', 'ACTIVE', 0, null, null, 'SYSTEM')
;
-- submitting
INSERT INTO addresses(id, street, street_additional, city, region, postal_code, country)
  VALUES(add_sub_id, '940 BLANCHARD', '', 'VICTORIA', 'BC', 'V8R 4P1', 'CA')
;
INSERT INTO mhr_parties(id, party_type, status_type, registration_id, change_registration_id, first_name, middle_name, 
                        ...
                        owner_group_id)
    VALUES(sub_id, 'SUBMITTING', 'ACTIVE', reg_id, reg_id, null, null, null, 'BCOL NEW (PVA)',
           mhr_name_compressed_key('BCOL NEW (PVA)'), add_sub_id, null, null, null, null)
;
-- owner
INSERT INTO addresses(id, street, street_additional, city, region, postal_code, country)
  VALUES(add_own_Id, '123 NEW HOME COURT', '', 'VANCOUVER', 'BC', 'V9M 1M1', 'CA')
;
INSERT INTO mhr_parties(id, party_type, status_type, registration_id, change_registration_id, first_name, middle_name, 
                        last_name, business_name, compressed_name, address_id, email_address, phone_number, phone_extension, 
                        owner_group_id)
    VALUES(owner_id, 'OWNER_BUS', 'ACTIVE', reg_id, reg_id, null, null, null, 'PROD VERIFICATION MANUFACTURER ORG', 
           mhr_name_compressed_key('PROD VERIFICATION MANUFACTURER ORG'), add_own_Id, null, null, null, null)
;
-- dealer/manufacturer
INSERT INTO mhr_parties(id, party_type, status_type, registration_id, change_registration_id, first_name, middle_name, 
                        last_name, business_name, compressed_name, address_id, email_address, phone_number, phone_extension, 
                        owner_group_id)
    VALUES(dealer_id, 'MANUFACTURER', 'ACTIVE', reg_id, reg_id, null, null, null, 'PROD VERIFICATION MANUFACTURER ORG',
           mhr_name_compressed_key('PROD VERIFICATION MANUFACTURER ORG'), add_own_Id, null, null, null, null)
;
INSERT INTO mhr_manufacturers(id, registration_id, submitting_party_id, owner_party_id, dealer_party_id,
                              manufacturer_name, account_id, bcol_account)
     VALUES (nextval('mhr_manufacturer_id_seq'), reg_id, sub_id, owner_id, dealer_id, 'PROD VERIFICATION MANUFACTURER ORG', '454', null)
;
