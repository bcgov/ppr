...
@cross_origin(origin='*')
@jwt.requires_auth
def post_notes(mhr_number: str):  # pylint: disable=too-many-return-statements
    ...
    try:
        ...
        current_reg: MhrRegistration = MhrRegistration.find_by_mhr_number(mhr_number, account_id, True)
