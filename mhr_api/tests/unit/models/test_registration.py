...
# testdata pattern is ({mhr_num}, {exists}, {reg_description})
TEST_SUMMARY_REG_DATA = [
    ('077741', True, 'Manufactured Home Registration'),
    ('TESTXX', False, None)
]


@pytest.mark.parametrize('mhr_num,exists,reg_desc', TEST_SUMMARY_REG_DATA)
def test_find_summary_by_mhr_number(session, mhr_num, exists, reg_desc):
