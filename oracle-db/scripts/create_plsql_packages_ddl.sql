...
-- ppr_util_pkg begin
CREATE OR REPLACE PACKAGE ppr_util_pkg AS
...
CREATE OR REPLACE PACKAGE BODY ppr_util_pkg AS
  ...
  is
   ...
   SELECT SEARCH_ID_SEQ.NEXTVAL INTO V_SEARCH_ID FROM DUAL;
 ...
 B ON 1 = 1
  ...
  is
   ...
   WHERE LPAD(REGEXP_REPLACE(MHR_NUMBER,'[$A-Za-z]','0'),6,'0') = V_KEY
