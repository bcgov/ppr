...
--financing_id         NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  ...
  EXPIRE_DATE          DATE,
  LIFE                 NUMBER,
  DISCHARGED           VARCHAR2(1 BYTE),
  RENEWED              VARCHAR2(1 BYTE),
...
--address_id           NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  ...
  STREET_LINE_1        VARCHAR2(100 BYTE),
  STREET_LINE_2        VARCHAR2(100 BYTE),
...
--party_id             NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  ...
  FIRST_NAME_FIRST     VARCHAR2(50 BYTE),
  FIRST_NAME_SECOND    VARCHAR2(50 BYTE),
  FIRST_NAME_THIRD     VARCHAR2(50 BYTE),
  LAST_NAME_FIRST      VARCHAR2(50 BYTE),
  LAST_NAME_SECOND     VARCHAR2(50 BYTE),
...
;
COMMENT ON COLUMN PARTY.FIRST_NAME_FIRST IS 'required for search';
COMMENT ON COLUMN PARTY.FIRST_NAME_SECOND IS 'required for search';
COMMENT ON COLUMN PARTY.FIRST_NAME_THIRD IS 'required for search';
COMMENT ON COLUMN PARTY.LAST_NAME_FIRST IS 'required for search';
COMMENT ON COLUMN PARTY.LAST_NAME_SECOND IS 'required for search';
...
(
--serial_collateral_id   NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
  serial_collateral_id   NUMBER NOT NULL,
...
COMMENT ON COLUMN SEARCH_RESULT.DOCUMENT_NUMBER IS 'required for IMS';
COMMENT ON COLUMN SEARCH_RESULT.BLOCK_NUMBER IS 'required for IMS';
