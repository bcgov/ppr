...
REGISTERING_CODE_MSG = "The client party code {} does not match any registering party. "
SECURED_CODE_MSG = "The client party code {} does not match any secured party."
DELETE_MISSING_ID_SECURED = "A party ID is required to delete a secured party. "
DELETE_MISSING_ID_DEBTOR = "A party ID is required to delete a debtor. "
INVALID_PARTY_ID_SECURED = "The party ID provided for deleting a secured party is invalid ({}). "
INVALID_PARTY_ID_DEBTOR = "The party ID provided for deleting a debtor is invalid ({}). "
INVALID_COUNTRY_REGISTERING = "The specified country {} for the registering party is invalid. "
INVALID_REGION_REGISTERING = "The specified region {} for the registering party is invalid. "
INVALID_COUNTRY_SECURED = "The specified country {} for the secured Party is not valid. "
INVALID_REGION_SECURED = "The specified region {} for the secured Party is not valid. "
INVALID_COUNTRY_DEBTOR = "The specified country {} for the debtor is not valid. "
INVALID_REGION_DEBTOR = "The specified region {} for the debtor is not valid. "
CHARACTER_SET_UNSUPPORTED = "The name {} contains unsupported characters. "
DUPLICATE_SECURED_PARTY_BUSINESS = "The same Secured Party Business cannot be added more than once. "
DUPLICATE_SECURED_PARTY_PERSON = "Tthe same Secured Party Person cannot be added more than once. "
INVALID_AMEND_PARTY_ID_SECURED = "The amendment party ID for adding a secured party is invalid ({}). "
INVALID_AMEND_PARTY_ID_DEBTOR = "The amendment party ID for adding a debtor is invalid ({}). "
