...
INSERT INTO client_party_branch(CLIENT_PARTY_ID, BRANCH_CODE, ADDRESS_ID, BCONLINE_ACCOUNT, CONTACT_NAME,CONTACT_AREA_CD,
			 CONTACT_PHONE_NUMBER, USERID, ID, EMAIL_ID, UPDATE_TS)
  VALUES (200000000,1,200000000,12345,'TEST SP CONTACT NAME','604','2171234', 'SPUSER', null, 'test-sp-client@gmail.com', null);
INSERT INTO client_party_branch(CLIENT_PARTY_ID, BRANCH_CODE, ADDRESS_ID, BCONLINE_ACCOUNT, CONTACT_NAME,CONTACT_AREA_CD,
			 CONTACT_PHONE_NUMBER, USERID, ID, EMAIL_ID, UPDATE_TS)
  VALUES (200000001,1,200000001,12345,'TEST RP CONTACT NAME','604','2171234', 'RPUSER', null, 'test-rp-client@gmail.com', null);
