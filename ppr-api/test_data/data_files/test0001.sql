...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
    ...
    VALUES(200000000, 'RP', 200000000, 200000000, null, null, 'TEST', '1', 'REGISTERING', null,
           null, 200000002, 'testrp@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id, email_id)
    VALUES(200000001, 'DI', 200000000, 200000000, null, null, 'TEST IND', '1', 'DEBTOR', null,
           null, 200000002, 'testdi@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id)
    VALUES(200000002, 'DC', 200000000, 200000000, null, null, null, null, null, 'TEST BUS 2 DEBTOR',
           null, 200000002)
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id)
