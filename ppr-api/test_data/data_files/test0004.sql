...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
    ...
    VALUES(200000011, 'RP', 200000003, 200000003, null, null, 'TEST', '4', 'REGISTERING', null,
           null, 200000005, 'testrp4@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id, email_id)
    VALUES(200000012, 'DI', 200000003, 200000003, null, null, 'TEST IND', '4', 'DEBTOR', null,
           null, 200000005, 'testdi4@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id, email_id)
    VALUES(200000014, 'RP', 200000004, 200000003, null, null, 'TEST-DISCHARGE', '4', 'REGISTERING', null,
           null, 200000006, 'testrp4@gmail.com')
;
UPDATE financing_statement
   SET state_type_cd = 'HIS', discharged = 'Y'
