...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
    ...
    VALUES(200000015, 'RP', 200000005, 200000004, null, null, 'TEST', '5', 'REGISTERING', null,
           null, 200000007, 'testrp5@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id, email_id)
    VALUES(200000016, 'DI', 200000005, 200000004, null, null, 'TEST IND', '5', 'DEBTOR', null,
           null, 200000007, 'testdi4@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id, email_id)
    VALUES(200000018, 'RP', 200000006, 200000004, null, null, 'TEST-RENEWAL', '5', 'REGISTERING', null,
           null, 200000008, 'testrp5@gmail.com')
;
