...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
    ...
    VALUES(200000020, 'RP', 200000008, 200000000, null, null, 'TEST-AMEND-CO', '7', 'REGISTERING', null,
           null, 200000010, 'testrp7@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id)
    VALUES(200000021, 'DC', 200000008, 200000000, null, null, null, null, null, 'TEST 7 AMEND DEBTOR',
           null, 200000010)
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id)
...
UPDATE serial_collateral
  SET registration_id_end = 200000008
WHERE serial_collateral_id = 200000001
;
-- TEST0007 end
