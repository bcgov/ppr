...
INSERT INTO registration(registration_id, financing_id, registration_number, base_reg_number, registration_type_cd,
    ...
    VALUES(200000009, 200000000, 'TEST0008', 'TEST0001', 'DT', 'CHANGE', sysdate, 'D-T-00C8', null,
...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
    ...
    VALUES(200000023, 'RP', 200000009, 200000000, null, null, 'TEST-CHANGE-DT', '8', 'REGISTERING', null,
           null, 200000011, 'testrp8@gmail.com')
;
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
                  middle_name, last_name, business_name, birth_date, address_id)
    VALUES(200000024, 'DC', 200000009, 200000000, null, null, null, null, null, 'TEST 8 TRANSFER DEBTOR',
           null, 200000011)
;
UPDATE party
   SET registration_id_end = 200000009
 WHERE party_id = 200000021
   AND party_type_cd = 'DC'
;
-- TEST0008 end
