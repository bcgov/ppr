...
INSERT INTO party(party_id, party_type_cd, registration_id, financing_id, registration_id_end, client_party_id, first_name,
    ...
    VALUES(200000027, 'RP', 200000011, 200000000, null, null, 'TEST-CHANGE-SU', '10', 'REGISTERING', null,
           null, 200000013, 'testrp10@gmail.com')
;
...
UPDATE serial_collateral
  SET registration_id_end = 200000011
WHERE serial_collateral_id = 200000006
;
-- TEST0010 end
