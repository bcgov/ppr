...
#def test_drafts_invalid_type_400(session, client, jwt):
def test_draft_create_invalid_type_400(client, jwt):
...
def test_draft_create_valid_financing_201(client, jwt):
...
def test_draft_create_valid_amendment_201(client, jwt):
...
def test_draft_valid_change_201(client, jwt):
...
def test_draft_get_list_200(client, jwt):
...
def test_draft_valid_get_statement_200(client, jwt):
...
def test_draft_invalid_get_statement_404(client, jwt):
...
def test_draft_update_invalid_type_400(client, jwt):
...
def test_draft_update_valid_financing_200(client, jwt):
...
def test_draft_update_valid_amendment_200(client, jwt):
...
def test_draft_update_valid_change_200(client, jwt):
...
#def test_draft_delete_204(client, jwt):
...
def test_draft_delete_404(client, jwt):
...
def test_draft_create_nonstaff_missing_account_400(client, jwt):
...
def test_draft_create_staff_missing_account_400(client, jwt):
...
def test_draft_create_nonstaff_unauthorized_404(client, jwt):
...
def test_draft_list_nonstaff_missing_account_400(client, jwt):
...
def test_draft_list_staff_missing_account_400(client, jwt):
...
def test_draft_list_nonstaff_unauthorized_404(client, jwt):
...
def test_draft_update_nonstaff_missing_account_400(client, jwt):
...
def test_draft_update_staff_missing_account_400(client, jwt):
...
def test_draft_update_nonstaff_unauthorized_404(client, jwt):
...
def test_draft_get_nonstaff_missing_account_400(client, jwt):
...
def test_draft_get_staff_missing_account_201(client, jwt):
...
def test_draft_get_nonstaff_unauthorized_404(client, jwt):
