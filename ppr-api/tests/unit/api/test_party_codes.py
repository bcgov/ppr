...
def test_party_valid_200(client, jwt):
    ...
    # test
    rv = client.get(f'/api/v1/party-codes/200000000',
                     headers=create_header_account(jwt, [STAFF_ROLE]))
    # check
    print(rv.json)
...
def test_party_nonstaff_unauthorized_404(client, jwt):
    ...
    # test
    rv = client.get(f'/api/v1/party-codes/5000009',
