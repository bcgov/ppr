    ...
    const generalCollateralDefaultValue = (): string => {
      switch (getRegistrationType.value.registrationTypeAPI) {
        ...
        case APIRegistrationTypes.RESIDENTIAL_PROPERTY_PROFIT_TAX:
            return 'All the debtor’s present and after acquired personal property, including but not restricted to machinery, equipment, furniture, fixtures, inventory and receivables.' // eslint-disable-line
