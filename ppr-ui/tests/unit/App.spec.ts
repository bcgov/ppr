...
// // Mock axios calls
// // Mock axios-auth module
// vi.mock('@/utils/axios-auth', () => {
//   const actual = vi.fn((url) => {
//     switch (url) {
...
// })
//
// // Mock axios-pay module
// vi.mock('@/utils/axios-pay', () => {
//   const actual = vi.fn((url) => {
//     if (url === `fees/PPR/${FeeCodes.SEARCH}`) {
//       return Promise.resolve({ data: { filingFees: 7, serviceFees: 1.5 }, status: StatusCodes.OK })
//     }
//   })
//   return { get: actual }
// })
//
// // Mock axios-ppr module
