...
describe('Attention', () => {
  it('renders the component properly', () => {
    const wrapper: Wrapper<any> = createComponent(Attention, attentionProps)
  ...
  it('adds a section number to title', () => {
    const wrapper: Wrapper<any> = createComponent(Attention, { ...attentionProps, sectionNumber: 1 })
  ...
  it('validates the attention', async () => {
    const wrapper: Wrapper<any> = createComponent(Attention, { sectionId, validate: true })
