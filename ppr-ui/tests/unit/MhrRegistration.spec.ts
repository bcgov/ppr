...
import { MHRButtonFooterConfig, MHRManufacturerButtonFooterConfig } from '@/resources/buttonFooterConfig'

describe.only('Mhr Registration', () => {
  ...
  beforeEach(async () => {
    ...
    // vi.spyOn(store, 'getFooterButtonConfig', 'get').mockReturnValue(MHRButtonFooterConfig)
    // vi.spyOn(store, 'getMhrRegistrationValidationModel', 'get').mockReturnValue({})
...
//     //vi.spyOn(store, 'getFooterButtonConfig', 'get').mockReturnValue(MHRManufacturerButtonFooterConfig)
