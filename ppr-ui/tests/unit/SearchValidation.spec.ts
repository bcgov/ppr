...
describe.skip('SearchBar base validation', () => {
  let wrapper
...
describe('Individual debtor validation', () => {
  ...
  it('gives validation messages/hints as user types', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toContain("don't normally contain special characters")
  })
})
...
describe('Business debtor validation', () => {
  ...
  it('prevents searching and gives validation when the search is empty', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Enter a business debtor name to search')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
  ...
  it('prevents searching when search value is less than minimum characters', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Must contain more than 1 character')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
  ...
  it('prevents searching when search value is more than maximum characters', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Maximum 150 characters')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
  ...
  it('gives validation messages/hints as user types', async () => {
    ...
    expect(messages1.at(1).text()).toContain('Maximum 150 characters')
  })
})
...
describe('Aircraft validation', () => {
  ...
  it('prevents searching and gives validation when the search is empty', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Enter an aircraft airframe D.O.T. number to search')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
  ...
  it('gives validation messages/hints as user types', async () => {
    ...
    const messages1 = wrapper.findAll('.v-messages__message')
    expect(messages1.length).toBe(2)
    expect(messages1.at(1).text()).toContain('Maximum 25 characters')
  })
})
...
describe('Registration number validation', () => {
  ...
  it('prevents searching and gives validation when the search is empty', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Enter a registration number to search')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
...
describe('organization name validation', () => {
  ...
  it('prevents searching and gives validation when the search is empty', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Enter an organization name to search')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
  ...
  it('prevents searching when search value is more than maximum characters', async () => {
    ...
    const messages = wrapper.findAll('.v-messages__message')
    expect(messages.length).toBe(2)
    expect(messages.at(1).text()).toBe('Maximum 70 characters')
    await nextTick()
    expect(getLastEvent(wrapper, searchError)).toBeNull()
    expect(getLastEvent(wrapper, searchData)).toBeNull()
  })
