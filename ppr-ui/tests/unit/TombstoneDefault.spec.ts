...
describe('TombstoneDefault component tests', () => {
  ...
  it('displays different headers for different auth roles', async () => {
    ...
    await assertHeaderForRole(wrapper, STAFF_MHR, 'Staff Manufactured Home and Personal Property Registries')
    await assertHeaderForRole(wrapper, CLIENT_MHR, 'My Manufactured Home Registry', [ProductCode.MHR])
    await assertHeaderForRole(wrapper, STAFF_PPR_MHR, 'Staff Manufactured Home and Personal Property Registries')
    await assertHeaderForRole(wrapper, CLIENT_PPR_MHR, 'My Manufactured Home and Personal Property Registries', [ProductCode.PPR, ProductCode.MHR])
    await assertHeaderForRole(wrapper, CLIENT_PPR_MHR, 'My Personal Property Registry', [ProductCode.PPR])
    await assertHeaderForRole(wrapper, HELP_DESK_PPR_MHR, 'Staff Manufactured Home and Personal Property Registries')
  })
})
